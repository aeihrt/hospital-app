            ...
            <div className="login-right">
                <div className="login-form-wrap">
                    <div className="login-card">
                        ...
                        <p className="login-subheading">Manage hospital appointments with ease</p>
                        ...
                        <div className="login-role-group">
                            <button
                                ...
                                className={`login-role-btn ${
                                    role === 'ADMIN' ? 'login-role-btn-active' : 'login-role-btn-inactive'
                                }`}
                            >
                                Admin
                            </button>
                        ...
                        <form onSubmit={handleSubmit} className="login-form">
                            ...
                            <div className="login-social">
                                ...
                                <button type="button" className="login-google-btn">
                                    ...
                                    <span className="login-google-label">Google</span>
                                </button>
                            </div>

                            <p className="login-terms">By signing in you agree to our Terms of Service and Privacy Policy</p>
